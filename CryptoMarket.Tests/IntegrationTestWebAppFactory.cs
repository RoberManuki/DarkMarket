...
{
    private readonly string _databaseName = $"cryptomarket-int-{Guid.NewGuid()}";
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configBuilder) =>
        {
            ...
            {
                ["ConnectionStrings:DefaultConnection"] = "Host=localhost;Port=5432;Database=cryptomarket_tests;Username=test;Password=test",
